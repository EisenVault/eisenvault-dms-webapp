...
div.panel
{
   ...
   <title>EisenVault Secure Document Storage &raquo; System Error</title>
</head>
<body>
   <div>
      <br/>
      <img src="${pageContext.request.contextPath}/res/themes/eisenVaultTheme/images/app-logo.png">
      <br/>
      <br/>
      ...
      <br/>
      <br/>
      <a href="http://www.eisenvault.net">EisenVault</a>. &copy; 2015 All rights reserved.
   </div>
   <div>
<%
out.println("<!--");
